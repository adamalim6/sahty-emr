...
async function runTenantMigrations() {
    console.log('--- Running Tenant Migration 110 (Admission Governance) ---');
    ...
    for (const clientRow of clients) {
        ...
        try {
            ...
            const sqlPath = path.join(__dirname, '../migrations/pg/tenant/110_admission_governance.sql');
            let sql = fs.readFileSync(sqlPath, 'utf8');
            console.log(`  Executing 110_admission_governance.sql...`);
