...
async function run() {
    ...
    const migrationPath = path.join(__dirname, '../migrations/pg/tenant/070_remove_admission_from_surveillance.sql');
    ...
    try {
        ...
        for (const row of res.rows) {
            ...
            try {
                ...
                console.log(`✅ ${dbName}: migration 070 applied successfully.`);
            } catch (err: any) {
