...
async function runTenantMigrations() {
    console.log('--- Running Tenant Migration 117 (seed default pharmacy location) ---');
    ...
    for (const clientRow of clients) {
        ...
        try {
            ...
            const sqlPath = path.join(__dirname, '../migrations/pg/tenant/117_seed_default_pharmacy_location.sql');
            let sql = fs.readFileSync(sqlPath, 'utf8');
            console.log(`  Executing 117_seed_default_pharmacy_location.sql...`);
