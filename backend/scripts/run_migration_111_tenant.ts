...
async function runTenantMigrations() {
    console.log('--- Running Tenant Migration 111 (Biology Specimen Lifecycle) ---');
    ...
    for (const clientRow of clients) {
        ...
        try {
            ...
            const sqlPath = path.join(__dirname, '../migrations/pg/tenant/111_biology_specimen_lifecycle.sql');
            let sql = fs.readFileSync(sqlPath, 'utf8');
            console.log(`  Executing 111_biology_specimen_lifecycle.sql...`);
