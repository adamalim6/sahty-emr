...
async function runTenantMigrations() {
    console.log('--- Running Tenant Migration 112 (LIMS Reception Schema) ---');
    ...
    for (const clientRow of clients) {
        ...
        try {
            ...
            const sqlPath = path.join(__dirname, '../migrations/pg/tenant/112_lims_reception_schema.sql');
            let sql = fs.readFileSync(sqlPath, 'utf8');
            console.log(`  Executing 112_lims_reception_schema.sql...`);
