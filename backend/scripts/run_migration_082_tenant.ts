...
async function runTenantMigrations() {
    console.log('--- Running Tenant Migrations 082 (Laboratory Reference Foundation) ---');
    ...
    for (const clientRow of clients) {
        ...
        try {
            ...
            const sqlPath = path.join(__dirname, '../migrations/pg/tenant/082_laboratory_reference_foundation.sql');
            let sql = fs.readFileSync(sqlPath, 'utf8');
            console.log(`  Executing 082_laboratory_reference_foundation.sql...`);
