...
async function run() {
    ...
    const migrationPath = path.join(__dirname, '../migrations/pg/tenant/072_cleanup_surveillance_triggers.sql');
    ...
    try {
        ...
        for (const row of res.rows) {
            ...
            try {
                ...
                console.log(`✅ ${dbName}: migration 072 applied successfully.`);
            } catch (err: any) {
