-- 082_laboratory_reference_foundation.sql
...
-- 6. LAB UNITS
--------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS reference.lab_units (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    code TEXT NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS reference.lab_analytes (
    ...
    default_unit_id UUID REFERENCES reference.lab_units(id),
    canonical_unit_id UUID REFERENCES reference.lab_units(id),
...
CREATE TABLE IF NOT EXISTS reference.lab_analyte_units (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    analyte_id UUID NOT NULL REFERENCES reference.lab_analytes(id),
    unit_id UUID NOT NULL REFERENCES reference.lab_units(id),
...
ALTER TABLE reference.global_actes ADD COLUMN IF NOT EXISTS lab_section_id UUID REFERENCES reference.lab_sections(id);
ALTER TABLE reference.global_actes ADD COLUMN IF NOT EXISTS lab_sub_section_id UUID REFERENCES reference.lab_sub_sections(id);

CREATE INDEX IF NOT EXISTS idx_ref_global_actes_lab_section_id ON reference.global_actes(lab_section_id);
CREATE INDEX IF NOT EXISTS idx_ref_global_actes_lab_sub_section_id ON reference.global_actes(lab_sub_section_id);

-- Explicitly enforce the rule that no sub-section can be provided without a section
ALTER TABLE reference.global_actes DROP CONSTRAINT IF EXISTS chk_ref_global_actes_lab_section_hierarchy;
...
ALTER TABLE reference.global_actes DROP COLUMN IF EXISTS default_specimen_type;
ALTER TABLE reference.global_actes DROP COLUMN IF EXISTS lims_template_code;
