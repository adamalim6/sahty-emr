...
const MIGRATION_PATH = path.join(__dirname, 'migrations', 'pg', 'tenant', '103_add_database_mode.sql');
...
async function applyMigration() {
    ...
    console.log(`Found ${tenantDatabases.length} tenant databases. Applying Phase 1 Prescription Normalization part 2...`);
