...
interface PartnerManagerProps {
  ...
  onAdd: (partner: PartnerInstitution) => void;
  onUpdate: (partner: PartnerInstitution) => void;
  onDelete: (id: string) => void;
}

export const PartnerManager: React.FC<PartnerManagerProps> = ({ partners, onAdd, onUpdate, onDelete }) => {
  ...
  const handleSave = () => {
    ...
    if (editingId) {
        onUpdate({ ...formData, id: editingId } as PartnerInstitution);
    } else {
      const newPartner: PartnerInstitution = {
        // ID generated by backend if strictly followed, but here we mock or expect backend to replace/ignore ID
        // Actually api.createPartner returns the new partner with ID. 
        // We pass local object, let parent handle API call.
