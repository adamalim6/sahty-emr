...
export const UnitsManager: React.FC = () => {
    ...
    const [unitForm, setUnitForm] = useState({ code: '', display: '', isUcum: true, isActive: true, sortOrder: 0 });
    ...
    const handleSaveUnit = async () => {
        try {
            ...
            setUnitForm({ code: '', display: '', isUcum: true, isActive: true, sortOrder: 0 });
            loadData();
        } catch (e) {
        ...
        <div className="p-8 h-full flex flex-col bg-slate-50 overflow-auto">
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    ...
                    <button onClick={() => { setIsCreatingUnit(true); setEditingUnitId(null); setUnitForm({ code: '', display: '', isUcum: true, isActive: true, sortOrder: 0 }); }} className="flex items-center space-x-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 shadow-sm transition-colors">
                        <Plus size={18} />
